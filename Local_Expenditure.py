def Local_Expenditure_page(pwd, site_num=1):
    ...
    import Labour, Material_Purchase, Staff_Salary, view_table, Home, View_Report
    ...
    home_button.grid(row=0, column=1, padx=[30,10], pady=10)
...
def D_Local_Expenditure_page(pwd, site_num=0):
    ...
    from tkcalendar import Calendar, DateEntry
    from PIL import Image, ImageTk
    import Labour, Material_Purchase, Staff_Salary, Managers_password, view_table, Home, View_Report
