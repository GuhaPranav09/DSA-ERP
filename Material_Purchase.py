def Material_Purchase_page(pwd, site_num=1):
    ...
    import Labour, Local_Expenditure, Staff_Salary, view_table, Home, View_Report
    ...
    insert_button.grid(row=8, column=1, pady=10, padx=[60,10])
    ...
    home_button.grid(row=0, column=1, padx=[40,10], pady=10)
...
def D_Material_Purchase_page(pwd, site_num=0):
    ...
    from tkcalendar import Calendar, DateEntry
    from PIL import Image, ImageTk
    import Labour, Local_Expenditure, Staff_Salary, Managers_password, view_table, Home, View_Report
